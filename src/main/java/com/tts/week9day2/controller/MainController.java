...
public class MainController {
    ...
    //this getting mapping tells spring to come here, and resolve this method when we reach localhost:8080
//    @GetMapping("/")
...
//    }
    ...
    //the number that will be displayed at this endpoint will be unique due to the Random class
    @GetMapping("/random")
    ...
    public Customer getCustomerById(@PathVariable Long id) {
        //orElseThrow means it will attempt to unwrap the optional, if there is nothing there, it will throw
        //an exception
